...
describe('AssignedDeviceList Component', () => {
    ...
    describe('render test', () => {
        ...
        it('should show code, type, brand, assing date, return date, end date, assignee name, project', () => {
            devices = [{
                    id: 'id',
                    full_code: 'some_code',
                    device_type_name: 'Laptop',
                    device_brand_name: 'HP',
                    assign_date: '01/01/2016',
            ...
            expect(row.innerHTML).toContain('Laptop');
            expect(row.innerHTML).toContain('HP');
            expect(row.innerHTML).toContain('01/01/2016');
            expect(row.innerHTML).toContain('02/01/2016');
            expect(row.innerHTML).toContain('03/01/2016');
            expect(row.innerHTML).toContain('some_name');
            expect(row.innerHTML).toContain('some_project');
        });
